...
def build_tx_to_contract(sender, contract, func, w3, args):
    ...
    store_data_tx = contract.functions[func](
        *args
    ).buildTransaction({
        'chainId': 3,
        'gas': 70000,
...
if __name__ == "__main__":
    ...
    addr = '0xfadD937FFeae8acd73649F22f8fb79fd2CBd9DBD'
    ...
    store_data_tx = build_tx_to_contract(sender.address, SimpleDataStorage, 'store', w3, [131])
